...
#ifdef CONFIG_MHL_PS5101_VE
u8 sii9234_checkActive(void)
{
	return sii9234_probed;
}
EXPORT_SYMBOL(sii9234_checkActive);
#endif
				       ...
				       struct class_attribute *attr, char *buf)
{
	...
	u8 sii_id = 0;
	struct sii9234_data *sii9234 = dev_get_drvdata(sii9244_mhldev);
	pr_info("sysfs_check_mhl_command\n");
					      ...
					      const struct i2c_device_id *id)
{
...
#ifdef CONFIG_MHL_PS5101_VE
	{
		...
		if(unlikely(ret < 0)){
			pr_info("sii9234 : goto err_exit0\n");
			goto err_exit1; 
		}
	}
#endif	
